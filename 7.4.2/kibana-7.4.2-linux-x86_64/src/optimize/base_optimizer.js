  ...
  getConfig() {
    ...
    const maybeAddCacheLoader = (cacheName, loaders) => {
      return [{
        loader: 'cache-loader',
        options: {
          cacheContext: (0, _utils.fromRoot)('.'),
    ...
    return this.uiBundles.getExtendedConfig((0, _webpackMerge.default)(commonConfig, _utils.IS_KIBANA_DISTRIBUTABLE ? isDistributableConfig : {}, this.uiBundles.isDevMode() ? (0, _webpackMerge.default)(watchingConfig, supportEnzymeConfig) : productionConfig));
  }
