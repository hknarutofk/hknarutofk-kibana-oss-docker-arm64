 ...
 * under the License.
 */
const IS_KIBANA_DISTRIBUTABLE = _package_json.pkg.build && _package_json.pkg.build.distributable === true;
exports.IS_KIBANA_DISTRIBUTABLE = IS_KIBANA_DISTRIBUTABLE;
const IS_KIBANA_RELEASE = _package_json.pkg.build && _package_json.pkg.build.release === true;
