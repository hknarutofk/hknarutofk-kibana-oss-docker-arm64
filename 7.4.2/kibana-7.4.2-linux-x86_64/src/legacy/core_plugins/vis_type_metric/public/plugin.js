...
function () {
  ...
  _createClass(MetricVisPlugin, [{
    ...
    value: function setup(core, _ref) {
      ...
      data.expressions.registerFunction(_metric_vis_fn.createMetricVisFn);
      visualizations.types.VisTypesRegistryProvider.register(_metric_vis_type.createMetricVisTypeDefinition);
    }
  }, {
    key: "start",
