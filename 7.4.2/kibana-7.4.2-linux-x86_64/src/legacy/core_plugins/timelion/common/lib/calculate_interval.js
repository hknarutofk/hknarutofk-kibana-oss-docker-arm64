...
var _to_milliseconds = _interopRequireDefault(require("../../server/lib/to_milliseconds.js"));
...
function calculateInterval(from, to, size, interval, min) {
  ...
  if ((0, _to_milliseconds.default)(dateMathInterval) < (0, _to_milliseconds.default)(min)) return min;
