...
function _default(directory) {
  ...
  const files = _lodash.default.map(_glob.default.sync(_path.default.resolve(__dirname, '../' + directory + '/*.js')), function (file) {
  ...
  const directories = _lodash.default.chain(_glob.default.sync(_path.default.resolve(__dirname, '../' + directory + '/*/index.js'))).filter(function (file) {
