...
var _date_math = _interopRequireDefault(require("../lib/date_math.js"));
...
function chainRunner(tlConfig) {
  ...
  function processRequest(request) {
    ...
    tlConfig.time.to = (0, _date_math.default)(request.time.to, true).valueOf();
    tlConfig.time.from = (0, _date_math.default)(request.time.from).valueOf();
