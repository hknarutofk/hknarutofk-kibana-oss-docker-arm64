  ...
  fn: function movingaverageFn(args, tlConfig) {
    return (0, _alter.default)(args, function (eachSeries, _window, _position) {
      ...
      if (typeof _window !== 'number') {
        ...
        const windowMilliseconds = (0, _to_milliseconds.default)(_window); // calculate how many buckets that _window represents

        const intervalMilliseconds = (0, _to_milliseconds.default)(tlConfig.time.interval); // Round, floor, ceil? We're going with round because it splits the difference.
