...
var _to_milliseconds = _interopRequireDefault(require("../../lib/to_milliseconds"));
  ...
  fn: function expsmoothFn(args, tlConfig) {
    ...
    _lodash.default.each(newSeries.list, function (series) {
      ...
      if (alpha != null && beta != null && gamma != null) {
        ...
        const season = Math.round((0, _to_milliseconds.default)(args.byName.season) / (0, _to_milliseconds.default)(tlConfig.time.interval));
