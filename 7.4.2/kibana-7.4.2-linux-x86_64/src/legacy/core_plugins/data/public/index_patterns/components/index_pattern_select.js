...
function () {
  ...
  return function getIndexPatternTitle(_x4, _x5) {
...
function createIndexPatternSelect(savedObjectsClient) {
  return function (props) {
    return _react.default.createElement(IndexPatternSelect, _extends({
...
function (_Component) {
  ...
  function IndexPatternSelect(props) {
    ...
    function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee3(indexPatternId) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                _context3.prev = 3;
                _context3.next = 6;
                return getIndexPatternTitle(_this.props.savedObjectsClient, indexPatternId);
    ...
    function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee4(searchValue) {
