...
function registerTutorials(server) {
  ...
  server.registerTutorial(_windows_event_logs.windowsEventLogsSpecProvider);
  ...
  server.registerTutorial(_nats_logs.natsLogsSpecProvider);
  server.registerTutorial(_coredns_metrics.corednsMetricsSpecProvider);
  server.registerTutorial(_coredns_logs.corednsLogsSpecProvider);
  server.registerTutorial(_auditbeat.auditbeatSpecProvider);
  server.registerTutorial(_iptables_logs.iptablesLogsSpecProvider);
  server.registerTutorial(_cisco_logs.ciscoLogsSpecProvider);
  server.registerTutorial(_envoyproxy_logs.envoyproxyLogsSpecProvider);
}