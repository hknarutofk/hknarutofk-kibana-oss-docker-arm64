...
const createLogstashInstructions = () => ({
  INSTALL: {
    OSX: [{
      title: _i18n.i18n.translate('kbn.common.tutorials.logstashInstructions.install.java.osxTitle', {
        defaultMessage: 'Download and install the Java Runtime Environment'
      }),
      textPre: _i18n.i18n.translate('kbn.common.tutorials.logstashInstructions.install.java.osxTextPre', {
      ...
      title: _i18n.i18n.translate('kbn.common.tutorials.logstashInstructions.install.logstash.osxTitle', {
        defaultMessage: 'Download and install Logstash'
      }),
      textPre: _i18n.i18n.translate('kbn.common.tutorials.logstashInstructions.install.logstash.osxTextPre', {
    ...
    WINDOWS: [{
      title: _i18n.i18n.translate('kbn.common.tutorials.logstashInstructions.install.java.windowsTitle', {
        defaultMessage: 'Download and install the Java Runtime Environment'
      }),
      textPre: _i18n.i18n.translate('kbn.common.tutorials.logstashInstructions.install.java.windowsTextPre', {
        defaultMessage: 'Follow the installation instructions [here]({link}).',
        values: {
      ...
      title: _i18n.i18n.translate('kbn.common.tutorials.logstashInstructions.install.logstash.windowsTitle', {
        defaultMessage: 'Download and install Logstash'
      }),
      textPre: _i18n.i18n.translate('kbn.common.tutorials.logstashInstructions.install.logstash.windowsTextPre', {
