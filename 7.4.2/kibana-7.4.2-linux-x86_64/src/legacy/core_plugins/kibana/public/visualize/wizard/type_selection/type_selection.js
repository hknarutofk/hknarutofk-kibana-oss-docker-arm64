...
function (_React$Component) {
  ...
  function TypeSelection() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderVisType", function (visType) {
      ...
      if (!('aliasUrl' in visType) && visType.stage === 'experimental') {
        ...
        var aliasDescription = _i18n.i18n.translate('kbn.visualize.newVisWizard.visTypeAliasDescription', {
      ...
      var onClick = 'aliasUrl' in visType ? function () {
        window.location = _chrome.default.addBasePath(visType.aliasUrl);
      } : function () {
  ...
  _createClass(TypeSelection, [{
    ...
    value: function render() {
      ...
      var visTypes = this.getFilteredVisTypes(this.props.visTypesRegistry, this.props.visTypeAliases, query);
    ...
    value: function filteredVisTypes(visTypes) {
      var _this2 = this;

      var visTypeAliases = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
      ...
      var allTypes = [].concat(_toConsumableArray(types), _toConsumableArray(visTypeAliases));
      var entries;
