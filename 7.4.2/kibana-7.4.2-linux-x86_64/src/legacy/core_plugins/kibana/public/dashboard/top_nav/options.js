...
/*#__PURE__*/
function (_Component) {
  _inherits(OptionsMenuUi, _Component);

  function OptionsMenuUi(props) {
    var _this;

    _classCallCheck(this, OptionsMenuUi);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(OptionsMenuUi).call(this, props));
  ...
  return OptionsMenuUi;
}(_react.Component);

var OptionsMenu = (0, _react2.injectI18n)(OptionsMenuUi);
