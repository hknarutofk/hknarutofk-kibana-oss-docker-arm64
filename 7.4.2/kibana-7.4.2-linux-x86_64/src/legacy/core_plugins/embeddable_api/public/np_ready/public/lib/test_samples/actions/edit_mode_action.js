...
exports.EditModeAction = exports.EDIT_MODE_ACTION = void 0;
...
/*#__PURE__*/
function (_Action) {
  _inherits(EditModeAction, _Action);

  function EditModeAction() {
    var _this;

    _classCallCheck(this, EditModeAction);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(EditModeAction).call(this, EDIT_MODE_ACTION));

    _defineProperty(_assertThisInitialized(_this), "type", EDIT_MODE_ACTION);

    return _this;
  }

  _createClass(EditModeAction, [{
    key: "getDisplayName",
...
exports.EditModeAction = EditModeAction;