  ...
  _createClass(DashboardGridUi, [{
    ...
    value: function renderPanels() {
      ...
      return _lodash.default.map(panelsInOrder, function (panel) {
        ...
        }, _react2.default.createElement(_embeddable_api.EmbeddableChildPanel, {
          embeddableId: panel.explicitInput.id,
          container: _this3.props.container,
          getActions: _this3.props.kibana.services.embeddable.getTriggerCompatibleActions,
    ...
    value: function render() {
      ...
      var isViewMode = viewMode === _embeddable_api.ViewMode.VIEW;
