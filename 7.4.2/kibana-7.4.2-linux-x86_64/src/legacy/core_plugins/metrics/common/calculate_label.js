...
function calculateLabel(metric, metrics) {
  if (!metric) return _i18n.i18n.translate('tsvb.calculateLabel.unknownLabel', {
    defaultMessage: 'Unknown'
  });
  if (metric.alias) return metric.alias;
  if (metric.type === 'count') return _i18n.i18n.translate('tsvb.calculateLabel.countLabel', {
    defaultMessage: 'Count'
  });

  if (metric.type === 'calculation') {
    return _i18n.i18n.translate('tsvb.calculateLabel.bucketScriptsLabel', {
      defaultMessage: 'Bucket Script'
    });
  }

  if (metric.type === 'math') return _i18n.i18n.translate('tsvb.calculateLabel.mathLabel', {
    defaultMessage: 'Math'
  });

  if (metric.type === 'series_agg') {
    return _i18n.i18n.translate('tsvb.calculateLabel.seriesAggLabel', {
  ...
  if (metric.type === 'filter_ratio') return _i18n.i18n.translate('tsvb.calculateLabel.filterRatioLabel', {
    defaultMessage: 'Filter Ratio'
  });

  if (metric.type === 'static') {
    return _i18n.i18n.translate('tsvb.calculateLabel.staticValueLabel', {
