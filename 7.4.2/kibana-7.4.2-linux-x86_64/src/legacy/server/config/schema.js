...
var _default = () => _joi.default.object({
  ...
  csp: _joi.default.object({
    ...
    strict: _joi.default.boolean().default(_csp.DEFAULT_CSP_STRICT),
    warnLegacyBrowsers: _joi.default.boolean().default(_csp.DEFAULT_CSP_WARN_LEGACY_BROWSERS)
  }).default(),
  ...
  map: _joi.default.object({
    ...
    emsLandingPageUrl: _joi.default.string().default('https://maps.elastic.co/v7.4'),
