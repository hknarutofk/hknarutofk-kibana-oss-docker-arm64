...
function DropPartialsParamEditor(props) {
  return _react.default.createElement(_switch.SwitchParamEditor, _extends({
    ...
    displayLabel: _i18n.i18n.translate('common.ui.aggTypes.dropPartialBucketsLabel', {
      defaultMessage: 'Drop partial buckets'
    }),
    displayToolTip: _i18n.i18n.translate('common.ui.aggTypes.dropPartialBucketsTooltip', {
