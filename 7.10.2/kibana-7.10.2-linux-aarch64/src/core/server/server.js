...
class Server {
  ...
  async setupCoreConfig() {
    const configDescriptors = [_utils.config, _csp.config, _elasticsearch.config, _logging.config, _http.config, _plugins.config, _dev.config, _kibana_config.config, _saved_objects2.savedObjectsConfig, _saved_objects2.savedObjectsMigrationConfig, _ui_settings.config, _metrics.opsConfig, _status.config, _environment.config];
