...
const visDataRoutes = (router, framework, {
  ...
  router.post({
    ...
    try {
      ...
      framework.logger.warn(`Request validation error: ${error.message} (saved object id: ${savedObjectId}). This most likely means your TSVB visualization contains outdated configuration. You can report this problem under https://github.com/elastic/kibana/issues/new?template=Bug_report.md`);
    }
