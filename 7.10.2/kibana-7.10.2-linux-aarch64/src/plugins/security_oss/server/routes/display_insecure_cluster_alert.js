...
exports.setupDisplayInsecureClusterAlertRoute = void 0;
 ...
 * under the License.
 */
const setupDisplayInsecureClusterAlertRoute = ({
  router,
  log,
  config$,
  displayModifier$,
  ...
  router.get({
    ...
    const hasData = await doesClusterHaveUserData(context.core.elasticsearch.client.asInternalUser, log);
    return response.ok({
      body: {
        displayAlert: hasData
      }
    });
  });
};

exports.setupDisplayInsecureClusterAlertRoute = setupDisplayInsecureClusterAlertRoute;