...
async function getDataTelemetry(esClient) {
  try {
    ...
    const indices = indexNames.map(name => {
      ...
      const baseIndexInfo = {
        name,
        isECS: !!((_indexMappings$name = indexMappings[name]) === null || _indexMappings$name === void 0 ? void 0 : (_indexMappings$name$m = _indexMappings$name.mappings) === null || _indexMappings$name$m === void 0 ? void 0 : (_indexMappings$name$m2 = _indexMappings$name$m.properties.ecs) === null || _indexMappings$name$m2 === void 0 ? void 0 : (_indexMappings$name$m3 = _indexMappings$name$m2.properties.version) === null || _indexMappings$name$m3 === void 0 ? void 0 : _indexMappings$name$m3.type),
