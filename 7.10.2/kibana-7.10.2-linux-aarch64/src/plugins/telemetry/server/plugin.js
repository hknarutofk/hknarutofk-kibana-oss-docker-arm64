...
class TelemetryPlugin {
  ...
  setup({
    ...
    (0, _telemetry_collection.registerCollection)(telemetryCollectionManager, elasticsearch.legacy.client, () => this.elasticsearchClient);
  ...
  start(core, {
    ...
    this.elasticsearchClient = elasticsearch.client; // Not catching nor awaiting these promises because they should never reject
