...
exports.ON_TOGGLE_LEGEND = 'ON_TOGGLE_LEGEND';
...
function onToggleLegend() {
    return { type: exports.ON_TOGGLE_LEGEND };
}
exports.onToggleLegend = onToggleLegend;
function onLegendItemOverAction(legendItemKey) {
    return { type: exports.ON_LEGEND_ITEM_OVER, legendItemKey: legendItemKey };
}
...
function onToggleDeselectSeriesAction(legendItemId, negate) {
    if (negate === void 0) { negate = false; }
    return { type: exports.ON_TOGGLE_DESELECT_SERIES, legendItemId: legendItemId, negate: negate };
}
