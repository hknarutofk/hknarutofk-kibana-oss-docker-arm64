...
function createOnElementOutCaller() {
    ...
    return function (state) {
        if (selector === null && state.chartType === __1.ChartTypes.Heatmap) {
            selector = re_reselect_1.default([heatmap_spec_1.getSpecOrNull, picked_shapes_1.getPickedShapes, get_settings_specs_1.getSettingsSpecSelector], function (spec, pickedShapes, settings) {
                if (!spec) {
                    return;
                }
