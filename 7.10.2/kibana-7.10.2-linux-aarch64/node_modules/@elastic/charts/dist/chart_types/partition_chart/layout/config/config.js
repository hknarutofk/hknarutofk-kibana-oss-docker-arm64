...
exports.configMetadata = {
    ...
    fillLabel: {
        type: 'group',
        values: __assign(__assign({ textColor: { type: 'color', dflt: '#000000' }, textInvertible: { dflt: false, type: 'boolean' }, textContrast: { dflt: false, type: 'boolean' || 'number' } }, fontSettings), { valueGetter: {
                dflt: sumValueGetter,
                type: 'function',
            }, valueFormatter: {
    ...
    linkLabel: {
        ...
        values: __assign(__assign({ maximumSection: {
            ...
            }, textColor: { dflt: '#000000', type: 'color' }, textInvertible: { dflt: false, type: 'boolean' }, textContrast: { dflt: false, type: 'boolean' || 'number' }, textOpacity: { dflt: 1, min: 0, max: 1, type: 'number' }, minimumStemLength: {
                dflt: 0,
                min: 0,
                max: 16,
                type: 'number',
