...
exports.getAxisSpecsSelector = re_reselect_1.default([getSpecs], function (specs) {
    return utils_1.getSpecsFromStore(specs, __1.ChartTypes.XYAxis, constants_1.SpecTypes.Axis);
})(get_chart_id_1.getChartIdSelector);
exports.getSeriesSpecsSelector = re_reselect_1.default([getSpecs], function (specs) {
    var seriesSpec = utils_1.getSpecsFromStore(specs, __1.ChartTypes.XYAxis, constants_1.SpecTypes.Series);
    return seriesSpec;
})(get_chart_id_1.getChartIdSelector);
exports.getAnnotationSpecsSelector = re_reselect_1.default([getSpecs], function (specs) {
    return utils_1.getSpecsFromStore(specs, __1.ChartTypes.XYAxis, constants_1.SpecTypes.Annotation);
})(get_chart_id_1.getChartIdSelector);
