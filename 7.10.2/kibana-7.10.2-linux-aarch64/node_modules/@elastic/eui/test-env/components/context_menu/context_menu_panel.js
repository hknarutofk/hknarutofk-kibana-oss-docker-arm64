    ...
    value: function render() {
      ...
      if (title) {
        if (Boolean(onClose)) {
          ...
          panelTitle = /*#__PURE__*/_react.default.createElement(_popover.EuiPopoverTitle, null, /*#__PURE__*/_react.default.createElement("span", {
            className: "euiContextMenu__itemLayout"
          }, title));
        }
      }
      ...
      var content = items && items.length ? items.map(function (MenuItem, index) {
        return MenuItem.type === _context_menu_item.EuiContextMenuItem ? /*#__PURE__*/(0, _react.cloneElement)(MenuItem, {
