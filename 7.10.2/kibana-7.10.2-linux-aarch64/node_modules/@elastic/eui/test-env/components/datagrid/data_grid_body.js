...
var EuiDataGridBody = function EuiDataGridBody(props) {
  ...
  var rows = (0, _react.useMemo)(function () {
    var rowsToRender = visibleRowIndices.map(function (rowIndex, i) {
      ...
      return /*#__PURE__*/_react.default.createElement(_data_grid_data_row.EuiDataGridDataRow, {
        key: rowIndex,
    ...
    if (renderFooterCellValue) {
      rowsToRender.push( /*#__PURE__*/_react.default.createElement(_data_grid_footer_row.EuiDataGridFooterRow, {
        key: "footerRow",
        leadingControlColumns: leadingControlColumns,
        trailingControlColumns: trailingControlColumns,
        columns: columns,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, rows);
};
