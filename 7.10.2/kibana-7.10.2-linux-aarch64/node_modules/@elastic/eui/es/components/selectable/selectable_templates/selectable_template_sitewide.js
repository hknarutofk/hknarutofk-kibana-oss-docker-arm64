...
export var EuiSelectableTemplateSitewide = function EuiSelectableTemplateSitewide(_ref) {
  ...
  return /*#__PURE__*/React.createElement(EuiSelectable, _extends({
    ...
    }, popoverTitle || popoverTrigger ? /*#__PURE__*/React.createElement(EuiPopoverTitle, null, popoverTitle, popoverTitle && search && /*#__PURE__*/React.createElement(EuiSpacer, null), search) : undefined, list, popoverFooter && /*#__PURE__*/React.createElement(EuiPopoverFooter, null, popoverFooter)));
  });
};
