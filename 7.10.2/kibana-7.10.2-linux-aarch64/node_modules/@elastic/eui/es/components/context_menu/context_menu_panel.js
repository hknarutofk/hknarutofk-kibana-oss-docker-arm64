    ...
    value: function render() {
      ...
      if (title) {
        if (Boolean(onClose)) {
          ...
          panelTitle = /*#__PURE__*/React.createElement(EuiPopoverTitle, null, /*#__PURE__*/React.createElement("span", {
            className: "euiContextMenu__itemLayout"
          }, title));
        }
      }
      ...
      var content = items && items.length ? items.map(function (MenuItem, index) {
        return MenuItem.type === EuiContextMenuItem ? /*#__PURE__*/cloneElement(MenuItem, {
