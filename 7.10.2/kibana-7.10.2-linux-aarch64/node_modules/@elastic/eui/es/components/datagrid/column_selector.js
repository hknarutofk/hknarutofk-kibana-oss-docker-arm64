...
export var useColumnSelector = function useColumnSelector(availableColumns, columnVisibility, showColumnSelector, displayValues) {
  ...
  var switchColumnPos = function switchColumnPos(fromColId, toColId) {
