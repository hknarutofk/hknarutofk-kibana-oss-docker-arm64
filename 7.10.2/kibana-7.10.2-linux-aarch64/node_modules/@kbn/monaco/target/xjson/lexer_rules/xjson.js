...
Object.defineProperty(exports, "ID", { enumerable: true, get: function () { return constants_1.ID; } });
require("./painless");
require("./esql");
...
monaco_1.monaco.languages.setMonarchTokensProvider(constants_1.ID, exports.lexerRules);
monaco_1.monaco.languages.setLanguageConfiguration(constants_1.ID, {
    brackets: [
        ['{', '}'],
        ['[', ']'],
    ],
